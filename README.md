...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 60" width="200" height="60">
  <rect x="10" y="42" width="80" height="8" rx="2" fill="#1E3A8A"/>
  <rect x="18" y="30" width="64" height="8" rx="2" fill="#2563EB"/>
  <rect x="26" y="18" width="48" height="8" rx="2" fill="#60A5FA"/>
  <line x1="10" y1="46" x2="18" y2="34" stroke="#1E3A8A" stroke-width="2" stroke-linecap="round"/>
  <line x1="18" y1="34" x2="26" y2="22" stroke="#2563EB" stroke-width="2" stroke-linecap="round"/>
  <line x1="90" y1="46" x2="82" y2="34" stroke="#2563EB" stroke-width="2" stroke-linecap="round"/>
  <line x1="82" y1="34" x2="74" y2="22" stroke="#60A5FA" stroke-width="2" stroke-linecap="round"/>
  <circle cx="10" cy="46" r="3" fill="#1E3A8A"/>
  <circle cx="90" cy="46" r="3" fill="#1E3A8A"/>
  <circle cx="18" cy="34" r="3" fill="#2563EB"/>
  <circle cx="82" cy="34" r="3" fill="#2563EB"/>
  <circle cx="26" cy="22" r="3" fill="#60A5FA"/>
  <circle cx="74" cy="22" r="3" fill="#60A5FA"/>
  <text x="105" y="28" font-family="system-ui,sans-serif" font-size="16" font-weight="700" fill="#60A5FA">Connective</text>
  <text x="105" y="48" font-family="system-ui,sans-serif" font-size="18" font-weight="900" fill="#2563EB">View</text>
</svg>
...
[![Location](https://img.shields.io/badge/Tampa_Bay_FL-07101F?style=flat&logoColor=white)](#)
...
**U.S. Military Veteran — USMC and USAF**
